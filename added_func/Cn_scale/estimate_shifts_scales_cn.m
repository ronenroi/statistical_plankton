function [est_shifts,shift_equations,est_scales,scale_equations,Corr]=estimate_shifts_scales_cn(pf,rotations,...
    max_shift,shift_step,max_scale,Nscales,memoryfactor,shifts_2d_ref,verbose)
%
