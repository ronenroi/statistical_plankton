function [clstack, corrstack, est_shifts, est_scales]=SEM_estimate_shifts_scales_like_aviad(pf,rotations,...
...
for shift_idx=1:Nequations
    ...
    for scale_index=1:Nscales
        ...
        if temp_correlation>corrstack(idxi,idxj)
           ...
           est_idx = temp_shiftidx;
        end
        
    end
    
    shifts_1d(idxi,idxj)=-max_shift+(est_idx-1)*shift_step;
